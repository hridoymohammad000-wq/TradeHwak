...
from app.double_down.demo_execution import DemoChallengeExecutor, DemoExecutionIntent
from app.double_down.enums import ChallengeDirection, ChallengeExchangeMode, ChallengeSlotType
...
class DoubleDownPhase10SafetyTests(unittest.TestCase):
    def test_exchange_enum_contains_no_live_mode(self):
        self.assertEqual(
            {mode.value for mode in ChallengeExchangeMode},
            {"paper", "demo"},
        )
